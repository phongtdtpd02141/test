...
public class NhanVienJFrame extends javax.swing.JFrame {
    ...
    void setModel(NhanVien model) {
        ...
        rdoTruongPhong.setSelected(model.isChucVu());
    ...
    NhanVien getModel() {
        ...
        model.setChucVu(rdoTruongPhong.isSelected());
        return model;
    }
        ...
        try {
            ...
            for (NhanVien nv : list) {
                Object[] row = {
                    nv.getMaNV(),
                    nv.getHoTen(),
                    nv.isChucVu() ? "Trưởng Phòng" : "Nhân Viên"};
                model.addRow(row);
            }
        } catch (Exception e) {
    ...
    void delete() {
        if (DialogHelper.confirm(this, "Bạn thực sự muốn xóa nhân viên này?")) {
            ...
            if (ShareHelper.USER.getMaNV().equals(manv)) {
                DialogHelper.alert(this, "Không được xóa chính mình");
            } else {
                try {
                    dao.delete(manv);
                    this.load();
    ...
    private void initComponents() {
        ...
        txtXacNhanMK.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        rdoTruongPhong.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 737, Short.MAX_VALUE)
                .addContainerGap())
